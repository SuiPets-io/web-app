...
interface FusionEggSuccessModalProps {
	eggInfo: EggType | null
	onClose: () => void
}

const FusionEggSuccessModal = ({
	eggInfo,
	onClose,
}: FusionEggSuccessModalProps) => {
		...
		<div className="fixed top-0 left-0 w-full h-full flex items-center justify-center z-50">
			...
			<div
				...
				<div className="flex flex-col gap-2 items-center">
					<Text>
						Congratulations! You got a <b>NORMAL</b> egg.
					</Text>
...
export default FusionEggSuccessModal
