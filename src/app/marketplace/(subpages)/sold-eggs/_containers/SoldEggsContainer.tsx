...
import GlobalEggsFilters from '../_components/SoldEggsFilters'
import { filterParamsAtom } from '../_store/marketAtom'
import useGetGlobalEgg from '../hooks/useGetSoldEggs'
...
const MysteryBoxContainer = () => {
	...
	const [renderData, setRenderData] = useState<RecentSoldItemType[]>([])
